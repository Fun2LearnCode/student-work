...
def move(x,y):
    if board[1][global_y][global_x].type:
        ...
        if board[1][global_y][global_x].color == "red" and turn%2 == 0 and global_y - y==1 and board[1][y][x] == 0 and abs(global_x - x) == 1:
            compress(x,y)
            return True
        elif board[1][global_y][global_x].color == "black" and turn%2 ==1 and global_y - y==-1 and board[1][y][x] == 0 and abs(global_x - x) == 1:
            compress(x,y)
            return True
    return False
def jump_piece(x,y):
    if board[1][global_y][global_x].type == False:
        if board[1][global_y][global_x].color == "black" and turn%2 ==1and y> global_y:
            if x<global_x and board[1][y][x] ==0 and board[1][y-1][x+1].color=="red":#black left
                ...
                compress_jump(x,y,-1,-1)
                return True
        elif  board[1][global_y][global_x].color == "red" and turn%2 ==0 and y<global_y:
        ...
        if board[1][global_y][global_x].color == "black" and turn%2 ==1:
            if y<global_y:
                if x>global_x:
                ...
                if x<global_x:
                    if board[1][y][x] ==0 and board[1][y-1][x+1].color=="red" :
                        ...
                        compress_jump(x,y,-1,-1)
                        return True
        elif board[1][global_y][global_x].color == "red" and turn%2 ==0:
            if y<global_y:
                if x> global_x:
...
def click(event):
    ...
    if board[0][y][x]["background"] == "black":
        if global_x == -1 :
            if board[1][y][x] != 0:
                if board[1][y][x].color == "black" and turn%2 ==1:
                    global_x = x
                    global_y = y
                    board[0][y][x]["background"] = "blue"
                elif board[1][y][x].color == "red" and turn%2 == 0:
                    global_x = x
                    global_y = y
                    board[0][y][x]["background"] = "blue"
        else:
            if board[1][y][x]!= 0 and board[1][y][x].color == "black" and turn%2 ==1:
                board[0][global_y][global_x]["background"] = "black"
                board[0][y][x]["background"] = "blue"
                global_x = x
                global_y =y
            elif board[1][y][x]!= 0 and board[1][y][x].color == "red" and turn%2 ==0:
                board[0][global_y][global_x]["background"] = "black"
                board[0][y][x]["background"] = "blue"
                global_x = x
                global_y =y
